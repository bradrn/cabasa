...
-- Usually a function such as this would be located in Common.hs, but
-- here this would cause a circular dependency between Common.hs and
-- Settings.hs, as Settings would use Common.showMessageDialog but
-- Common would require one of the functions from Settings. This
